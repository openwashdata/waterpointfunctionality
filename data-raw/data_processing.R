...
data_in <- readr::read_csv("data-raw/water point functionality.csv")
...
waterpointfunctionality <- data_in

# Export Data ------------------------------------------------------------------
usethis::use_data(waterpointfunctionality, overwrite = TRUE)
fs::dir_create(here::here("inst", "extdata"))
readr::write_csv(waterpointfunctionality,
                 here::here("inst", "extdata", paste0("waterpointfunctionality", ".csv")))
openxlsx::write.xlsx(waterpointfunctionality,
                     here::here("inst", "extdata", paste0("waterpointfunctionality",
                                                          ".xlsx")))
